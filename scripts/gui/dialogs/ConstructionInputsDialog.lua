--[[
    TODO:
    - Check that the dialog works as intended
    - Maybe resize the dialog to make it more compact
    - Fix guiProfiles to make it look good, the listItem* profiles may
      be a bit wrong..
    - Maybe use "disabled" to mark completed inputs? (set profile)
]]
---@class Input
